package com.jiao.ts_recruit.controller;
import com.jiao.ts_recruit.pojo.Recruit;
import com.jiao.ts_recruit.service.RecruitService;
...
public class RecruitController {
	...
	public Result findNewlist(){
		return new Result(true,StatusCode.OK,"查询成功",recruitService.findNewlist("0"));
	}
