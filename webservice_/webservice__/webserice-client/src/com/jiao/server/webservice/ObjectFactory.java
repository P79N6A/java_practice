 ...
 * generated in the com.jiao.server.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetName_QNAME = new QName("http://webservice.server.jiao.com/", "getName");
    private final static QName _GetNameResponse_QNAME = new QName("http://webservice.server.jiao.com/", "getNameResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.jiao.server.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.server.jiao.com/", name = "getName")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.server.jiao.com/", name = "getNameResponse")
